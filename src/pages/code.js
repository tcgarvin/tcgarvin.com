    ...
    <Grid>
      <Row>
        <Col xs={12}>
          ...
          <p>Time's flown since 2012, and I've picked up a few things along the way. ou can browse some of them here if you want. Most of them are regrettably closed-source, but I've linked to Github when possible.</p>
        </Col>
      </Row>
    </Grid>
          ...
          <Col xs={12}>
            <Masonry>
              ...
              <Showcase title="Dots" imageUrl="/images/ucd-thumbnail.png">
                ...
                <p>Dots was an experiment in data visualization that would scrape the several systems of record that we cared about, and provide intuitive visualizations for our most common questions.  (Typically, "What am I suppose to work on next", "How is everyone doing", "Is anyone falling behind", "Are there any emergency situations brewwing", "Are customer situations staffed correctly", and that sort of thing.</p>
              ...
              <Showcase title="APAR Wizard" imageUrl="/images/ucd-thumbnail.png">
                ...
                <p> This tool saw excellent adoption in my team.  I like to think it saved weeks of developer time during it's lifetime.</p>
              </Showcase>
              ...
              <Showcase title="Hashnav" imageUrl="/images/github-thumbnail.png" link="https://github.com/tcgarvin/hashnav">
                ...
                <p>Was prety much just an excuse to learn Neo4J.</p>
              </Showcase>
            </Masonry>
          </Col>
        </Row>
